...
public:
    ...
    //获得所有的节点
    NodeVector GetNodes()const{return m_Nodes;};
...
//                    newNode.setIndex(GetNextFreeNodeIndex());
...
//                    newNode1.setIndex(GetNextFreeNodeIndex());
